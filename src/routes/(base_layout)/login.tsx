...
const validateUsername = server$(async (username: unknown) => {
...
const validatePassword = server$(async (password: unknown) => {
  ...
  const [loggingIn, { Form }] = createServerAction$(async (form: FormData) => {
    ...
    switch (loginType)
    {
      case "login": 
      {
        ...
        if (!user) 
        {
          throw new FormError(`Username/Password combination is incorrect`, { fields });
        }
      ...
      case "register": 
      {
        ...
        if (userExists) 
        {
          throw new FormError(`User with username ${username} already exists`, { fields });
        }
